...
use Tooling\LaravelAuthorizerValidator\Concerns\ValidatesNodes;

class FixAuthorizersAndValidators extends AbstractRector
{
    use ValidatesNodes;
    ...
    public function refactor(Node $node): null|Node
    {
        ...
        // Rule 3: Ensure Authorizer or Validator classes are final
        if (! $node->isFinal()) {
