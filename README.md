# Request Authorizers Validators
...
### Generate Authorizers and Validators
...
Authorizers and Validators split the traditional Laravel `FormRequest` into 2 discrete classes. They can be leveraged in Controllers like this
