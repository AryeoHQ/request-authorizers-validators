...
Each command also has an option to generate the corresponding authorizer or validator class
```sh
php artisan make:authorizer MyAuthorizer --v
php artisan make:validator MyValidator --a
```
